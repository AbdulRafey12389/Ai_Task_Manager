...
function HomePage() {
  return (
    <>
      ...
      <section>
        <div className='container !px-8 grid grid-cols-1 items-center gap-8 mx-auto xl:gap-12 xl:grid-cols-[1fr_1.5fr]'>
          <div className='flex flex-col items-center text-center space-y-4 lg:text-left lg:items-start lg:space-y-6'>
            <h1 className='text-4xl font-semibold max-w-[22ch] md:text-5xl lg:text-6xl xl:text-5xl 2xl:text-6xl'>
              Simply Your Work and Life with{' '}
              <span className='inline-flex bg-gradient-to-t from-primary/50 to-primary/30 rounded-full px-2 '>
                AI—Powered
              </span>{' '}
              Task Management.
            </h1>
